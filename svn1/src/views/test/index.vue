    ...
    <div class="container_table">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        />
        <!-- <el-table-column v-model="id" style="display:none" prop="id" label="ID" align="center" /> -->
  ...
  methods: {
    ...
    addInfo() {
      ...
      this.$axios
        ...
        // .post(url, {
        //   data: {
        //     deviceClass: this.form.deviceClass,
        //     type: this.form.type,
        //     file: this.fileList,
    ...
    getData() {
      ...
      this.$axios
        ...
        .then(res => {
          ...
          // this.currentPage = 1
          this.activePage = 1
          console.log(this.activePage, '测试当前页')
          console.log(this.currentPage, '测试currentPage')
...
.app-container .el-table--striped .el-table__body tr.el-table__row--striped td {
  background: #f2f2f2;
}
.app-container .el-table td {
  padding: 0 0;
}
.app-container .el-dialog .el-table td {
  padding: 6px 0;
}
.app-container
  .el-dialog
