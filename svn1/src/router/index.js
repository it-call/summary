...
export const constantRoutes = [
  ...
  },
  {
    ...
    //     path: 'monitoring',
    //     name: 'monitoring',
    //     component: () => import('@/views/data/dataList/monitoring'),
    //     meta: { title: '车辆监控' }
    //   },
    //   {
    //     path: 'analyze',
    //     name: 'analyze',
    //     component: () => import('@/views/data/dataList/analyze'),
    //     meta: { title: '分析统计' }
    //   },
    //   {
    //     path: 'setting',
    //     name: 'setting',
    //     component: () => import('@/views/data/dataList/setting'),
    //     meta: { title: '管理设置' }
    //   }
    // ]
    // hidden: true
    ...
    children: [
      {
        path: 'index',
        name: 'Form',
        component: () => import('@/views/carRegister/index'),
        meta: { title: '车辆注册', icon: 'form' }
      }
    ]
  },
